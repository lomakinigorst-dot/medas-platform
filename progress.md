...
Текущий блок: Фаза E — /clinic/[slug] ✅ ЗАВЕРШЕНА
Последнее ✅: обе страницы клиники задеплоены (V1 + V2 Стич), HTTP 200. Шапка: слоган видим на всех экранах и при скролле. Коммит 90571fb
Следующее: Фаза F — /doctor/[slug]/booking (форма записи) ИЛИ H.1 — бонусы в MobileBookingBar
