...
Текущий блок: Фаза D — UX-правки после релиза
Последнее ✅: sticky-сайдбар — max-h + overflow + бонусы (+5% за визит, до 10% списание). task_plan.md дополнен Фазой H (бонусная программа)
Следующее: Фаза E — /clinic/[slug] (страница клиники) ИЛИ H.1 — бонусы в MobileBookingBar
